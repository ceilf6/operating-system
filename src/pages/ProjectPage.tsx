    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        <article className="glass-card rounded-[32px] p-6">
          ...
          <h2 className="page-title mt-4 text-3xl text-[color:var(--ink-1)]">项目文档与实现</h2>
          <div className="mt-5 space-y-4">
            {projectAssets.map((asset) => (
              ...
              >
                ...
                <p className="mt-2 text-sm leading-7 text-[color:var(--ink-2)]">{asset.path}</p>
                {asset.excerpt ? (
        ...
        <article className="glass-card rounded-[32px] p-6">
          <div className="eyebrow">Teacher Media</div>
          <h2 className="page-title mt-4 text-3xl text-[color:var(--ink-1)]">教师补充素材</h2>
          <div className="mt-5 space-y-4">
